...
#$ -j y
#$ -N runMutect_chrY
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrY.8May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrY.8May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/mutectCalls.chrY.vcf
