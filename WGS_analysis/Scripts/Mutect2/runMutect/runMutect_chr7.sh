...
#$ -j y
#$ -N runMutect_chr7
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7.8May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7.8May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/mutectCalls.chr7.vcf
