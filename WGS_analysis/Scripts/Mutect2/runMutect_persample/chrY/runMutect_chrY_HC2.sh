...
#$ -R y
#$ -j y
#$ -N runMutect_chrY_HC2
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrY_HC2.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrY_HC2.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chrY_HC2.vcf
