...
#$ -R y
#$ -j y
#$ -N runMutect_chr21_A6A
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr21_A6A.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr21_A6A.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr21_A6A.vcf
