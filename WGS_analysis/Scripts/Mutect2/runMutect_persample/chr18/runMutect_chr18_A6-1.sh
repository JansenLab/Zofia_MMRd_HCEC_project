...
#$ -R y
#$ -j y
#$ -N runMutect_chr18_A6-1
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr18_A6-1.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr18_A6-1.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr18_A6-1.vcf
