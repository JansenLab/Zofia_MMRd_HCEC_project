...
#$ -R y
#$ -j y
#$ -N runMutect_chr7_HC1
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7_HC1.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7_HC1.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr7_HC1.vcf
