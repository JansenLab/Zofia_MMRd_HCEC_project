...
#$ -R y
#$ -j y
#$ -N runMutect_chr7_C1-1
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7_C1-1.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr7_C1-1.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr7_C1-1.vcf
