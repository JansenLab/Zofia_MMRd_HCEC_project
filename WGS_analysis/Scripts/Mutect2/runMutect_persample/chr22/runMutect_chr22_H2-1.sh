...
#$ -R y
#$ -j y
#$ -N runMutect_chr22_H2-1
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr22_H2-1.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr22_H2-1.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr22_H2-1.vcf
