...
#$ -j y
#$ -N A5B_strelka2 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports_HC2/A5B.16Aug2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports_HC2/A5B.16Aug2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_HC2/A5B/ 
...
/SAN/colcc/MMRd_CRC/WGS/output/strelka/strelka-2.9.2.centos6_x86_64/bin/configureStrelkaSomaticWorkflow.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_HC2/A5B/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_HC2/A5B/runWorkflow.py -m local -j 20
