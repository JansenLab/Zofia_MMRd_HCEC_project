...
#$ -j y
#$ -N D6B_manta 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/manta/reports/D6B.26Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/manta/reports/D6B.26Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/manta/output/D6B/ 
...
/share/apps/genomics/manta-1.6.0/bin/configManta.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/manta/output/D6B/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/manta/output/D6B/runWorkflow.py -m local -j 20
