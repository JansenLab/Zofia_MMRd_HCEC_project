...
#$ -j y
#$ -N B8A_strelka2 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports/B8A.10Jul2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports/B8A.10Jul2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output/B8A/ 
...
/SAN/colcc/MMRd_CRC/WGS/output/strelka/strelka-2.9.2.centos6_x86_64/bin/configureStrelkaSomaticWorkflow.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output/B8A/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/strelka2/output/B8A/runWorkflow.py -m local -j 20
