...
#$ -j y
#$ -N A2-2_strelka2 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports_MC/A2-2.2Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/strelka2/reports_MC/A2-2.2Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_MC/A2-2/ 
...
/SAN/colcc/MMRd_CRC/WGS/output/strelka/strelka-2.9.2.centos6_x86_64/bin/configureStrelkaSomaticWorkflow.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_MC/A2-2/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/strelka2/output_MC/A2-2/runWorkflow.py -m local -j 20
