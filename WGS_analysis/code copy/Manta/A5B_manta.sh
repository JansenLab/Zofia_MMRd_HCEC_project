...
#$ -j y
#$ -N A5B_manta 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/manta/reports/A5B.26Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/manta/reports/A5B.26Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/manta/output/A5B/ 
...
/share/apps/genomics/manta-1.6.0/bin/configManta.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/manta/output/A5B/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/manta/output/A5B/runWorkflow.py -m local -j 20
