...
#$ -j y
#$ -N A2-2_manta 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/manta/reports/A2-2.26Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/manta/reports/A2-2.26Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/manta/output/A2-2/ 
...
/share/apps/genomics/manta-1.6.0/bin/configManta.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/manta/output/A2-2/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/manta/output/A2-2/runWorkflow.py -m local -j 20
