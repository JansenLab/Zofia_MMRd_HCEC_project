...
#$ -j y
#$ -N F7-1_manta 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/manta/reports/F7-1.26Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/manta/reports/F7-1.26Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/manta/output/F7-1/ 
...
/share/apps/genomics/manta-1.6.0/bin/configManta.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/manta/output/F7-1/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/manta/output/F7-1/runWorkflow.py -m local -j 20
