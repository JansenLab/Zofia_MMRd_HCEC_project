...
#$ -j y
#$ -N B8A_manta 
#$ -e /SAN/colcc/MMRd_HCEC_genomes/manta/reports/B8A.26Sep2024.err 
#$ -o /SAN/colcc/MMRd_HCEC_genomes/manta/reports/B8A.26Sep2024.out 

mkdir /SAN/colcc/MMRd_HCEC_genomes/manta/output/B8A/ 
...
/share/apps/genomics/manta-1.6.0/bin/configManta.py \
  ...
  --runDir /SAN/colcc/MMRd_HCEC_genomes/manta/output/B8A/ 
                   
# execution on a single local machine with 20 parallel jobs
 /SAN/colcc/MMRd_HCEC_genomes/manta/output/B8A/runWorkflow.py -m local -j 20
