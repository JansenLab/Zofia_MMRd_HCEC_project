...
#$ -j y
#$ -N runMutect_chrX
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrX.8May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrX.8May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/mutectCalls.chrX.vcf
