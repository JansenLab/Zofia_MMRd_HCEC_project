...
#$ -j y
#$ -N runMutect_chr17
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr17.8May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr17.8May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/mutectCalls.chr17.vcf
