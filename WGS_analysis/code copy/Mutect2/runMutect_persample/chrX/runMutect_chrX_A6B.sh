...
#$ -R y
#$ -j y
#$ -N runMutect_chrX_A6B
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrX_A6B.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chrX_A6B.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chrX_A6B.vcf
