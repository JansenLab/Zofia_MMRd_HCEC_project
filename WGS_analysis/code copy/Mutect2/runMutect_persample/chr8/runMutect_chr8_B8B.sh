...
#$ -R y
#$ -j y
#$ -N runMutect_chr8_B8B
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr8_B8B.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr8_B8B.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr8_B8B.vcf
