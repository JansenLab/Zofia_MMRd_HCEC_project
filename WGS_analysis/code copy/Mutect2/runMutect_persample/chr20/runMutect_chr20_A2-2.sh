...
#$ -R y
#$ -j y
#$ -N runMutect_chr20_A2-2
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr20_A2-2.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr20_A2-2.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr20_A2-2.vcf
