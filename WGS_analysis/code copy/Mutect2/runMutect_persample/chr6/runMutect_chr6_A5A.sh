...
#$ -R y
#$ -j y
#$ -N runMutect_chr6_A5A
#$ -e /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr6_A5A.28May2024.err
#$ -o /SAN/colcc/MMRd_HCEC_genomes/mutect2/reports/mutect_chr6_A5A.28May2024.out
...
-O /SAN/colcc/MMRd_HCEC_genomes/mutect2/vcf_files/persample/mutectCalls.chr6_A5A.vcf
